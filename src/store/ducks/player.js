...
export default function player(state = INITIAL_STATE, action) {
    switch(action.type) {
        case Types.LOAD:
            return { ...state, currentSong: action.payload.song, list: action.payload.list, status: Sound.status.PLAYING, position: null, duration: null, positionShown: null };
        case Types.PLAY:
        ...
        case Types.NEXT: {
            ...
            if (next) {
                return { ...state, currentSong: next, status: Sound.status.PLAYING, position: null, duration: null, positionShown: null };
            }
        ...
        case Types.PREV:{
            ...
            if (prev) {
                return { ...state, currentSong: prev, status: Sound.status.PLAYING, position: null, duration: null, positionShown: null };
            }
